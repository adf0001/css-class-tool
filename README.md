...
<!-- setClass(elList, addClassList, removeClassList, toggleClassList, framePrefix)-->
...
<!-- var setClassByElement(classList, addElList, removeElList, toggleElList, framePrefix) -->
<label><input type=checkbox 
	onchange="var chs=parentNode.parentNode.childNodes;
